...
export default function CantidadesTable(props) {
            ...
            <CardBody>
              <GridContainer>
                  <GridItem xs={12} sm={4} md={4}>
                      Total &nbsp;&nbsp;
                      <Chip color="primary"  label={nFormat.fn(props.data.total)}>Total</Chip> 
                  </GridItem>
                  <GridItem xs={12} sm={4} md={4}>
              ...
              <ThemeProvider theme={themeTable}>
                <MaterialTable
                  columns={[
                    ...
                    { title: "Cantidad", field: "SumaCantidad",width:115 ,type:'numeric'  },
